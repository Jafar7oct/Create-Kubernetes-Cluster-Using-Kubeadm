...
```
👉 Why?
This ensures containerd uses the systemd cgroup driver — required for proper integration with kubelet and Kubernetes resource management.
Mismatched drivers = chaos! 🚫
...
### Just On Control Plane Node (Master)
